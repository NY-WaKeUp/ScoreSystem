  ...
  <div class="login-wrap">
    <el-form class="login-container" :model="form" :rule="rules">
      ...
      <el-form-item  prop="password">
        <el-input type="password" v-model="form.password" placeholder="请输入用户密码" autocomplete="off" show-password></el-input>
      </el-form-item>
      <el-form-item  prop="level">
        <el-select v-model="form.level" placeholder="请输入权限等级" style="width: 100%">
  ...
  data:function(){
    return {
      ...
      rules:{
        ...
        level:[
          {required:true,message:'请选择登录等级',trigger:'blur'}
        ],
      }
    }
  },
