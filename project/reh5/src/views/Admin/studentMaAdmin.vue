    ...
    >
      ...
      <el-form ref="form" :rules="rules" :inline="true" :model="form" label-width="80px">
        ...
        <el-form-item label="班级" prop="klass">
          <el-input placeholder="请输入班级" v-model="form.klass"></el-input>
        </el-form-item>
        <el-form-item label="专业" prop="major">
          <el-select v-model="form.major" placeholder="请选择性别">
...
<script>
import {getStudentInfo, editStudent, deleteUser, addStudent, searchStudent, searchTeacher} from '../../api/index'
export default {
  data(){
    return {
      input: '',
  ...
  methods: {
    ...
    onSubmitToSea(){
      if(this.input === ''){
        ...
        // })
        searchStudent({name:this.input}).then(({data}) =>{
          this.tableData = data.data
        })
      }
    }
