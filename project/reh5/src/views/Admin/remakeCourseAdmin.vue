...
<div>
  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="showRemakeSubmit">确 定</el-button>
      </span>
  </el-dialog>

  <el-button  @click="showRemake" type="primary">查看课程重修学生</el-button>
...
<script>
import {remakeCourseAdmin} from '../../api/index'
export default {
  data(){
    return {
      form:{
  ...
  methods:{
    ...
    showRemakeSubmit(){
      remakeCourseAdmin(this.form).then(({data})=>{
        console.log(data);
        if(data.code === 0){
          this.$message({
            message: '查看成功',
